...
<div class="transaction-index">
    ...
    <p>
        <?= Html::a(Yii::t('atpay', 'Create Transaction'), ['create'], ['class' => 'btn btn-success']) ?>
        <?= Html::a(Yii::t('atpay', 'Advance Search'), '#', ['class' => 'btn btn-info search-button']) ?>
    </p>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Taban users', 'id' => 'grid-transaction-search-uid']
            ],
        'date',
        'price',
        'description',
